...
public class DefaultParametersException extends Exception {
    public DefaultParametersException() {
        super("Please instantiate 'AzDDefaultParameters' class with mandatory parameters 'organization' and 'personal access token' before calling any functions in this library.");
    }
