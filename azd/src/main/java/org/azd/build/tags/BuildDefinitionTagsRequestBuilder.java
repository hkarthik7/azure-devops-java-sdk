...
public class BuildDefinitionTagsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public CompletableFuture<BuildTags> add(int definitionId, String tag) throws AzDException {
     ...
     * @throws AzDException Default Api Exception handler.
     */
    public CompletableFuture<BuildTags> add(int definitionId, List<String> tags) throws AzDException {
     ...
     * @throws AzDException Default Api Exception handler.
     */
    public CompletableFuture<Void> delete(int definitionId, String tag) throws AzDException {
     ...
     * @throws AzDException Default Api Exception handler.
     */
    public CompletableFuture<BuildTags> get(int definitionId) throws AzDException {
     ...
     * @throws AzDException Default Api Exception handler.
     */
    public CompletableFuture<BuildTags> get(int definitionId, int revision) throws AzDException {
        var reqInfo = toGetRequestInformation();
        reqInfo.serviceEndpoint = reqInfo.serviceEndpoint + "/" + definitionId + "/tags";
     ...
     * @throws AzDException Default Api Exception handler.
     */
    public CompletableFuture<BuildTags> update(int definitionId, List<String> tags, boolean toRemove) throws AzDException {
