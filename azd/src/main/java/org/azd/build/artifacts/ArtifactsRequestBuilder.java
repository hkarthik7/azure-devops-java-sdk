...
public class ArtifactsRequestBuilder extends BaseRequestBuilder {
     ...
     **/
    public CompletableFuture<BuildArtifact> create(int buildId, BuildArtifact buildArtifact) throws AzDException {
     ...
     * @throws AzDException Default Api Exception handler.
     **/
    public CompletableFuture<BuildArtifact> get(int buildId, String artifactName) throws AzDException {
     ...
     * @throws AzDException Default Api Exception handler.
     **/
    public CompletableFuture<InputStream> getAsZip(int buildId, String artifactName) throws AzDException {
     ...
     * @throws AzDException Default Api Exception handler.
     **/
    public CompletableFuture<InputStream> getFile(int buildId, String artifactName, String fileId,
     ...
     * @throws AzDException Default Api Exception handler.
     **/
    public CompletableFuture<BuildArtifacts> list(int buildId) throws AzDException {
