...
public class FeedPermission extends SerializableEntity {
    ...
    public boolean getIsInheritedRole() {
        return isInheritedRole;
    }

    public void setIsInheritedRole(boolean isInheritedRole) {
        this.isInheritedRole = isInheritedRole;
    }
    ...
    public void setRole(FeedRole role) {
        this.role = role;
    }
