...
public class Feed extends SerializableEntity {
    /**
     * Related REST links.
     **/
    @JsonProperty("_links")
    ...
    public FeedCapabilities getCapabilities() {
        return capabilities;
    }

    public void setCapabilities(FeedCapabilities capabilities) {
    ...
    public boolean getHideDeletedPackageVersions() {
    ...
    public boolean getUpstreamEnabled() {
    ...
    public List<UpstreamSource> getUpstreamSources() {
        return upstreamSources;
    }

    public void setUpstreamSources(List<UpstreamSource> upstreamSources) {
