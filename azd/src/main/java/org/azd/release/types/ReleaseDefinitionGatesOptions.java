...
public class ReleaseDefinitionGatesOptions extends SerializableEntity {
    /**
    ...
    public Integer getMinimumSuccessDuration() {
        return minimumSuccessDuration;
    }

    public void setMinimumSuccessDuration(Integer minimumSuccessDuration) {
    ...
    public void setStabilizationTime(Integer stabilizationTime) {
