...
public class ManualIntervention extends SerializableEntity {
    ...
    public ReleaseDefinitionShallowReference getReleaseDefinition() {
        return releaseDefinition;
    }

    public void setReleaseDefinition(ReleaseDefinitionShallowReference releaseDefinition) {
        this.releaseDefinition = releaseDefinition;
    }

    public ReleaseEnvironmentShallowReference getReleaseEnvironment() {
        return releaseEnvironment;
    }

    public void setReleaseEnvironment(ReleaseEnvironmentShallowReference releaseEnvironment) {
    ...
    public void setStatus(ManualInterventionStatus status) {
        this.status = status;
    }
