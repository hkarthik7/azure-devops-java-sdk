...
public class ReleaseDefinition extends SerializableEntity {
    /**
    ...
    public ReleaseReference getLastRelease() {
        return lastRelease;
    }

    public void setLastRelease(ReleaseReference lastRelease) {
    ...
    public ReleaseDefinitionSource getSource() {
        return source;
    }

    public void setSource(ReleaseDefinitionSource source) {
        this.source = source;
    }
    ...
    public List<Integer> getVariableGroups() {
        return variableGroups;
    }

    public void setVariableGroups(List<Integer> variableGroups) {
    ...
    public void setVariables(Map<String, ConfigurationVariableValue> variables) {
