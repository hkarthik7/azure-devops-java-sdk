...
public class ReleaseDeployPhase extends SerializableEntity {
    /**
    ...
    public void setPhaseType(DeployPhaseTypes phaseType) {
    ...
    public void setStatus(DeployPhaseStatus status) {
        this.status = status;
    }
