...
public class TaskInputDefinitionBase extends BaseAbstractMethod {
	...
	public String getHelpMarkDown() { return helpMarkDown; }

	public void setHelpMarkDown(String helpMarkDown) { this.helpMarkDown = helpMarkDown; }
	...
	public TaskInputValidation getValidation() { return validation; }

	public void setValidation(TaskInputValidation validation) { this.validation = validation; }

	public String getVisibleRule() { return visibleRule; }
