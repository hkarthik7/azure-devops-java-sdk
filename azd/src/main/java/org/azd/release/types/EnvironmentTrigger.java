...
public class EnvironmentTrigger extends SerializableEntity {
    /**
    ...
    public Integer getDefinitionEnvironmentId() {
        return definitionEnvironmentId;
    }

    public void setDefinitionEnvironmentId(Integer definitionEnvironmentId) {
        this.definitionEnvironmentId = definitionEnvironmentId;
    }

    public Integer getReleaseDefinitionId() {
        return releaseDefinitionId;
    }

    public void setReleaseDefinitionId(Integer releaseDefinitionId) {
    ...
    public EnvironmentTriggerType getTriggerType() {
        return triggerType;
    }

    public void setTriggerType(EnvironmentTriggerType triggerType) {
