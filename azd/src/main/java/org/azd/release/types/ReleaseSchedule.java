...
public class ReleaseSchedule extends SerializableEntity {
    /**
    ...
    public void setDaysToRelease(ScheduleDays daysToRelease) {
    ...
    public boolean getScheduleOnlyWithChanges() {
