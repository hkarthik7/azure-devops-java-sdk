...
public class EnvironmentRetentionPolicy extends SerializableEntity {
    /**
    ...
    public Integer getReleasesToKeep() {
        return releasesToKeep;
    }

    public void setReleasesToKeep(Integer releasesToKeep) {
