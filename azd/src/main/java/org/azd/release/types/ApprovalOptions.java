...
public class ApprovalOptions extends SerializableEntity {
    ...
    public boolean getAutoTriggeredAndPreviousEnvironmentApprovedCanBeSkipped() {
    ...
    public boolean getEnforceIdentityRevalidation() {
    ...
    public Integer getRequiredApproverCount() {
        return requiredApproverCount;
    }

    public void setRequiredApproverCount(Integer requiredApproverCount) {
