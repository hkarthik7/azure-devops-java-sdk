...
public class EnvironmentOptions extends SerializableEntity {
    /**
    ...
    public boolean getAutoLinkWorkItems() {
    ...
    public boolean getPublishDeploymentStatus() {
    ...
    public boolean getPullRequestDeploymentEnabled() {
