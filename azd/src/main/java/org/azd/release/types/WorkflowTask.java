...
public class WorkflowTask extends SerializableEntity {
    /**
    ...
    public Integer getRetryCountOnTaskFailure() {
        return retryCountOnTaskFailure;
    }

    public void setRetryCountOnTaskFailure(Integer retryCountOnTaskFailure) {
