...
public class UserEntitlementOperationReference extends SerializableEntity {
	/**
	...
	**/
	...
	private List<UserEntitlementOperationResult> results;
	/**
	...
	**/
	...
	public List<UserEntitlementOperationResult> getResults() { return results; }

	public void setResults(List<UserEntitlementOperationResult> results) { this.results = results; }
