...
public class GroupEntitlementOperationReference extends SerializableEntity {
	/**
	...
	**/
	...
	private List<GroupOperationResult> results;
	/**
	...
	**/
	...
	public List<GroupOperationResult> getResults() { return results; }

	public void setResults(List<GroupOperationResult> results) { this.results = results; }
