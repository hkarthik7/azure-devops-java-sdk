...
public class RunCreateModel extends SerializableEntity {
    ...
    public void setCustomTestFields(List<CustomTestField> customTestFields) {
    ...
    public void setEnvironmentDetails(DtlEnvironmentDetails environmentDetails) {
    ...
    public void setRunSummary(List<RunSummaryModel> runSummary) {
