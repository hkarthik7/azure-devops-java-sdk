...
public class MavenApi extends AzDAsyncApi<MavenApi> implements MavenDetails {
    ...
    public void deletePackageVersion(String feedId, String groupId, String artifactId, String version)
            throws AzDException {
        send(RequestMethod.DELETE, CONNECTION, MAVEN, CONNECTION.getProject(),
                AREA + "/feeds", feedId,
                "maven/groups/" + groupId + "/artifacts/" + artifactId + "/versions/" + version,
                ApiVersion.MAVEN, null, null);
    }
    ...
    public void updatePackageVersion(String feedId, String groupId, String artifactId, String version, String promote) throws AzDException {
        ...
        send(RequestMethod.PATCH, CONNECTION, MAVEN, CONNECTION.getProject(),
                AREA + "/feeds", feedId,"maven/groups/" + groupId + "/artifacts/" + artifactId + "/versions/" + version,ApiVersion.MAVEN, null,body,null);
    }
}
