...
public class Project {
     ...
     * @return array of projects {@link Projects}
     */
    public List<PatchOperation> getWorkitemDeltas(Integer workItemId, AzDDefaultParameters defaultParameters) {
        try {
            String r = Request.request(RequestMethod.GET, defaultParameters, ResourceId.CORE, id,
     ...
     * @return array of projects {@link Projects}
     */
    public WorkitemSummaries getWorkitemRevisions(Integer workItemId, AzDDefaultParameters defaultParameters) {
        try {
            String r = Request.request(RequestMethod.GET, defaultParameters, ResourceId.CORE, id,
                    "wit/workitems", ""+workItemId, "revisions", CoreVersion.PROJECT_WORK_ITEM_REVISIONS, null, null);
