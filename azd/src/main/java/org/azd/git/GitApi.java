...
public class GitApi extends AzDAsyncApi<GitApi> implements GitDetails {
	 ...
	 *
	 * @param repositoryId
	 *            provide the repository id
	 * @param repositoryName
	 *            pass the repository name to rename
	 * @param defaultBranchName
	 *            pass the default branch name to set
	 * @throws AzDException
	 *             Default Api Exception handler.
	 ...
	 * @param reviewers
	 *            A list of reviewers on the pull request along with the state
	 *            of their votes.
	 * @throws AzDException
	 *             Default Api Exception handler.
	 ...
	 *            The description of the pull request.
	 * @param isDraft
	 *            if set to true the pull request will be in draft mode.
	 * @return an object of git pull request {@link PullRequest}
	 * @throws AzDException
	 *             Default Api Exception handler.
	 */
	 ...
	 *
	 * @param repositoryName
	 *            The repository name of the pull request's target branch.
	 * @param pullRequestId
	 ...
	 * non-default project you have to call setProject method from
	 * {@link Connection}.
	 *
	 * @throws AzDException
	 *             Default Api Exception handler.
	 ...
	 *
	 * @param skip
	 *            The number of pull requests to ignore. For example, to
	 *            retrieve results 101-150, set top to 50 and skip to 100.
	 * @param top
	 *            The number of pull requests to retrieve.
	 * @param creatorId
	 *            If set, search for pull requests that were created by this
	 *            identity.
	 * @param includeLinks
	 *            Whether to include the _links field on the shallow references
	 * @param repositoryId
	 *            If set, search for pull requests whose target branch is in
	 *            this repository.
	 * @param reviewerId
	 *            If set, search for pull requests that have this identity as a
	 *            reviewer.
	 * @param sourceRefName
	 *            If set, search for pull requests from this branch.
	 * @param sourceRepositoryId
	 *            If set, search for pull requests whose source branch is in
	 *            this repository.
	 * @param status
	 *            If set, search for pull requests that are in this state.
	 *            Defaults to Active if unset.
	 ...
	 * @param isLocked
	 *            true to lock the branch and false to unlock.
	 ...
	 *            ID of the reviewer.
	 * @param vote
	 *            Vote on a pull request: 10 - approved 5 - approved with
	 *            suggestions 0 - no vote -5 - waiting for author -10 - rejected
	 * @param isRequired
	 *            Indicates if this is a required reviewer for this pull
	 *            request.
	 ...
	 *            ID of the reviewer.
	 * @param isFlagged
	 *            Indicates if this reviewer is flagged for attention on this
	 *            pull request.
	 * @param hasDeclined
	 *            Indicates if this reviewer has declined to review this pull
	 *            request.
	 * @return PullRequestReviewer {@link PullRequestReviewer}
	 * @throws AzDException
	 *             Default Api Exception handler.
	 ...
	 *            Name of the repository.
	 * @param ids
	 *            If provided, specifies the exact commit ids of the commits to
	 ...
	 * @param version
	 *            Version string identifier (name of tag/branch, SHA1 of
	 *            commit).
	 * @param versionOptions
	 *            Version options - Specify additional modifiers to version (e.g
	 *            Previous).
	 * @param versionType
	 *            Version type (branch, tag, or commit). Determines how Id is
	 *            interpreted.
	 * @param excludeDeletes
	 *            Only applies when an itemPath is specified. This determines
	 *            whether to exclude delete entries of the specified path.
	 * @param fromCommitId
	 *            If provided, a lower bound for filtering commits
	 *            alphabetically.
	 * @param toCommitId
	 *            If provided, an upper bound for filtering commits
	 *            alphabetically
	 * @param fromDate
	 *            If provided, only include history entries created after this
	 *            date (string).
	 * @param toDate
	 *            If provided, only include history entries created before this
	 *            date (string)
	 * @param historyMode
	 *            What Git history mode should be used. This only applies to the
	 ...
	 * @param includeLinks
	 *            Whether to include the _links field on the shallow references
	 * @param includePushData
	 *            Whether to include the push information
	 * @param includeUserImageUrl
	 ...
	 * @param showOldestCommitsFirst
	 *            If enabled, this option will ignore the itemVersion and
	 *            compareVersion parameters.
	 * @param user
	 *            Alias or display name of the committer
	 * @param itemVersion
	 *            Version string identifier (name of tag/branch, SHA1 of commit)
	 * @param itemVersionOptions
	 *            Version options - Specify additional modifiers to version (e.g
	 *            Previous)
	 ...
	 *            Defaults to true.
	 * @param top
	 *            The maximum number of commits to return ("get the top x
	 *            commits").
	 * @param skip
