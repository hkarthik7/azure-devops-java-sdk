...
public class GitPullRequest extends SerializableEntity {
    ...
    public String getCompletionQueueTime() {
        return completionQueueTime;
    }

    public void setCompletionQueueTime(String completionQueueTime) {
    ...
    public boolean getHasMultipleMergeBases() {
    ...
    public PullRequestMergeFailureType getMergeFailureType() {
        return mergeFailureType;
    }

    public void setMergeFailureType(PullRequestMergeFailureType mergeFailureType) {
    ...
    public void setMergeStatus(PullRequestAsyncStatus mergeStatus) {
