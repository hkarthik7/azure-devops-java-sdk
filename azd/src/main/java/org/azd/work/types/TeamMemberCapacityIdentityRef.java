...
public class TeamMemberCapacityIdentityRef extends BaseAbstractMethod {
	/**
	...
	**/
	...
	public List<DateRange> getDaysOff() { return daysOff; }

	public void setDaysOff(List<DateRange> daysOff) { this.daysOff = daysOff; }

	public Author getTeamMember() { return teamMember; }

	public void setTeamMember(Author teamMember) { this.teamMember = teamMember; }
