...
public class TaskAgent extends SerializableEntity {
    /**
    ...
    public void setStatus(TaskAgentStatus status) {
        this.status = status;
    }
    ...
    public void setSystemCapabilities(Object systemCapabilities) {
        this.systemCapabilities = systemCapabilities;
    }

    public Object getUserCapabilities() {
        return userCapabilities;
    }

    public void setUserCapabilities(Object userCapabilities) {
