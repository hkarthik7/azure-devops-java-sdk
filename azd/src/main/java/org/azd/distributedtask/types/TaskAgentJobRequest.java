...
public class TaskAgentJobRequest extends SerializableEntity {
    ...
    public Object getAgentSpecification() {
        return agentSpecification;
    }

    public void setAgentSpecification(Object agentSpecification) {
    ...
    public void setMatchedAgents(List<TaskAgentReference> matchedAgents) {
        this.matchedAgents = matchedAgents;
    }

    public boolean getMatchesAllAgentsInPool() {
