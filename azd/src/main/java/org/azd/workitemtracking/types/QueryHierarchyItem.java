...
public class QueryHierarchyItem extends SerializableEntity {
    ...
    public void setFilterOptions(LinkQueryMode filterOptions) {
    ...
    public Author getLastExecutedBy() {
        return lastExecutedBy;
    }

    public void setLastExecutedBy(Author lastExecutedBy) {
    ...
    public QueryRecursionOption getQueryRecursionOption() {
        return queryRecursionOption;
    }

    public void setQueryRecursionOption(QueryRecursionOption queryRecursionOption) {
